...
/*   Updated: 2026/06/10 20:35:08 by miokrako         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void load_texture(t_game *game, int idx)
{
    t_texture   *tex;
...
static int  init_textures(t_game *game)
{
    load_texture(game, NORTH);
    load_texture(game, SOUTH);
    load_texture(game, EAST);
    load_texture(game, WEST);
    return (0);
}
